...
export type ConnectFn = (roomOverride?: string) => Promise<void>;
...
export const ConnectionProvider = ({
  ...
  const connect: ConnectFn = async (roomOverride) => {
    const finalRoom = roomOverride || pgState.roomName || (globalThis as any).__lk_room;
  ...
  useEffect(() => {
    // Removed auto-disconnect tied to OpenAI key
